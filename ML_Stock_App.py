...
def get_top_stock():
    ...
    try:
        ...
        return "S&P 500", sp500_data.iloc[-1]["Close"] if not sp500_data.empty else None
    except Exception:
        return None, None
...
def main():
    ...
    top_stock_name, top_stock_price = get_top_stock()
    if top_stock_name and top_stock_price:
    ...
    if st.button("Predict"):
        ...
        if stock_symbol:
            ...
            if stock_data is not None:
                ...
                # Ensure stock details are shown properly
